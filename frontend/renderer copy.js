    ...
    function connectWebSocket() {
        ...
        ws.onmessage = (event) => {
            ...
            if (streaming) {
                ...
                // Update plots
                Plotly.update(altitudeGraph, { x: [timeData], y: [altitudeData] }, [0]);
                Plotly.update(temperatureGraph, { x: [timeData], y: [temperatureData] }, [0]);
                Plotly.update(velocityGraph, { x: [timeData], y: [velocityData] }, [0]);
            }
        };
